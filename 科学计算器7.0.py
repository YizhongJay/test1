...
root = tk.Tk()
root.geometry("2560x1440")#450x680
root.title("科学计算器")
...
video_label.grid(row=0, column=0, pady=(0, 10))
...
#font_path="WD-XLLubrifontSC-Regular.otf"
#custom_font = font.Font(family="CustomFont", name="custom_font", exists=True, file=font_path)
...
for button_text in buttons:
    button = tk.Button(button_frame, text=button_text, width=6,height=2,font="WD-XLLubrifontSC-Regular",bg='#666', fg='white')
